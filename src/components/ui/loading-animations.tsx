export function HourglassLoader() {
  return (
    <svg
      aria-label="ampulheta animada com areia caindo"
      role="img"
      height="56px"
      width="56px"
      viewBox="0 0 56 56"
      className="tw-hg-loader"
    >
      <defs>
        <clipPath id="tw-hg-sand-mound-top">
          <path
            ...
            className="tw-hg-sand-mound-top"
          />
        </clipPath>
        <clipPath id="tw-hg-sand-mound-bottom">
          <path
            ...
            className="tw-hg-sand-mound-bottom"
          />
        </clipPath>
      </defs>
      <g transform="translate(2,2)">
        ...
        >
          ...
          <circle
            ...
            cx={26}
            strokeWidth={1}
            className="tw-hg-motion-thin"
          />
        </g>
        <g transform="translate(13.75,9.25)" className="tw-hg-model">
          <path
          ...
          <g strokeLinecap="round" stroke="hsl(35,90%,90%)">
            <line
              ...
              strokeWidth={1}
              className="tw-hg-sand-grain-left"
            />
            <line
              y2="21.75"
              x2="12.5"
              ...
              strokeDasharray="0.25 33.75"
              strokeWidth={1}
              className="tw-hg-sand-grain-right"
            />
            <line
              y2="31.5"
              x2="12.25"
            ...
            <line
              ...
              strokeWidth={1}
              stroke="hsl(35,90%,83%)"
              className="tw-hg-sand-line-left"
            />
            <line
              y2="31.5"
              x2="12.5"
              ...
              strokeWidth={1}
              stroke="hsl(35,90%,83%)"
              className="tw-hg-sand-line-right"
            />
          ...
          <g strokeWidth={2} strokeLinecap="round" opacity="0.7" fill="none">
            <path
              ...
              stroke="hsl(0,0%,100%)"
              className="tw-hg-glare-top"
            />
            <path
              transform="rotate(180,12.25,16.75)"
              d="M 19.437 3.421 C 19.437 3.421 19.671 6.454 17.914 8.846 C 16.157 11.238 14.5 11.5 14.5 11.5"
              stroke="hsla(0,0%,100%,0)"
              className="tw-hg-glare-bottom"
            />
          </g>
...
export function PencilLoader() {
  return (
    <div className="text-sky-700/80" aria-hidden="true">
      <svg
      ...
      >
        <defs>
          <clipPath id="tw-pencil-eraser-clip">
        ...
        <circle
          ...
          fill="none"
          r={70}
          className="tw-pencil__stroke"
        />
        <g transform="translate(100,100)" className="tw-pencil__rotate">
          <g fill="none">
            <circle
              transform="rotate(-90)"
            ...
            <circle
              ...
              r={54}
              className="tw-pencil__body3"
            />
          </g>
          <g transform="rotate(-90) translate(49,0)" className="tw-pencil__eraser">
            <g className="tw-pencil__eraser-skew">
              <rect height={30} width={30} ry={5} rx={5} fill="hsl(223,90%,70%)" />
              <rect
                clipPath="url(#tw-pencil-eraser-clip)"
                height={30}
                width={5}
                fill="hsl(223,90%,60%)"
              />
          ...
          <g transform="rotate(-90) translate(49,-30)" className="tw-pencil__point">
...
export function LoadingTextLoader() {
  return (
    <div className="tw-text-loader" aria-hidden="true">
      <span className="tw-tl-l">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 11 18" height={18} width={11} className="tw-text-letter">
      ...
      <span className="tw-tl-o">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 18" height={18} width={16} className="tw-text-letter">
      ...
      <span className="tw-tl-a">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 18" height={18} width={15} className="tw-text-letter">
      ...
      <span className="tw-tl-d">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 18" height={18} width={14} className="tw-text-letter">
      ...
      <span className="tw-tl-i">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 17" height={18} width={6} className="tw-text-letter tw-text-letter-i">
      ...
      <span className="tw-tl-n">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 13 18" height={18} width={13} className="tw-text-letter">
